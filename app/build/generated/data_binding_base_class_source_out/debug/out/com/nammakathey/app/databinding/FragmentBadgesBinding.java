...
public final class FragmentBadgesBinding implements ViewBinding {
  ...
  private FragmentBadgesBinding(@NonNull LinearLayout rootView, @NonNull TextView badgeCountText,
      @NonNull LinearLayout emptyState, @NonNull TextView emptyStateText,
      @NonNull RecyclerView rvBadges) {
  ...
  public static FragmentBadgesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentBadgesBinding((LinearLayout) rootView, badgeCountText, emptyState,
          emptyStateText, rvBadges);
    }
